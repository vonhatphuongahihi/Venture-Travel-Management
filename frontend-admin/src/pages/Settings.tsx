          ...
          <div className="flex gap-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Đây là một hệ thống quản lý du lịch toàn diện được thiết kế để hợp lý hóa việc
                    quản lý và giám sát các hoạt động du lịch tại Thành phố Bacolod. Hệ thống cung
                    cấp cho nhân viên quản lý tour du lịch những công cụ mạnh mẽ để quản lý tour du
                    lịch, các điểm tham quan, theo dõi lượt khách và tạo ra các báo cáo chi tiết.
                  </p>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Được xây dựng với các công nghệ web hiện đại, nền tảng này đảm bảo quản lý dữ
                    liệu hiệu quả, giảm sát thời gian thực và điều phối liền mạch giữa các phòng ban
                    du lịch khác nhau. Mục tiêu của chúng tôi là nâng cao trải nghiệm của du khách
                    đồng thời cung cấp phương thông tin quý giá cho phát triển du lịch bền vững.
                  </p>
                </div>

                <div>
                  <h2 className="text-lg font-semibold text-gray-700 mb-3">Thông tin liên lạc</h2>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 text-sm">
                      ...
                      <span className="text-gray-700">
                        Bacolod City Government Center, Bacolod City, Negros Occidental
                      </span>
                    </div>
                    <div className="flex items-start gap-3 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 border">
              ...
              <div className="space-y-4">
                <div className="flex gap-2 items-center">
                  <div className="flex items-center gap-6 border-gray-200">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-800">Nhân viên quản trí tour</h3>
                ...
                {hasChanges() && <p className="text-xs text-amber-600">• Có thay đổi chưa lưu</p>}
