                    ...
                    <div className="flex gap-8">
                        ...
                        <aside className="w-64 bg-white/80 rounded-lg p-4 shadow-lg hover:shadow-xl transition-shadow duration-200">
                            ...
                            <nav className="space-y-2">
                                <Link
                                    to="#"
                                    className="block text-m  py-2 px-3 rounded-md border text-primary border border-primary/50"
                                >
                                    Hồ sơ của tôi
                                </Link>
                                <Link
                                        ...
                                        <div className="text-center relative">
                                            ...
                                            <div className="relative inline-block">
                                                <img
                                                    src={avatarSrc}
                                                    alt="avatar"
                                                    className="h-28 w-28 mb-6 rounded-full object-cover mx-auto block"
                                                />
                                            ...
                                            {selectedFile && (
                                                <p className="text-xs text-primary mt-2">
                                                    Ảnh mới được chọn: {selectedFile.name}
                                                </p>
                                            )}
                                        </div>
                                    </div>
